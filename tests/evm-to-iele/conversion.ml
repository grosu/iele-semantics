...
let alloc_registers (ops: iele_op list) : iele_op list = 
  ...
  VoidOp(`REGISTERS !regbits + 1,[]) :: VoidOp(`FUNCTION("deposit"),[]) :: VoidOp(`FUNCTION("ECREC"),[]) :: VoidOp(`FUNCTION("ID"),[]) :: VoidOp(`FUNCTION("ECADD"),[]) :: VoidOp(`FUNCTION("ECMUL"),[]) :: VoidOp(`CALLDEST(0, 0), []) :: (lbl_ops @ dangling_jumpdests) 
